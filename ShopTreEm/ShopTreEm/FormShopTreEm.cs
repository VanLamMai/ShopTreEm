...
namespace ShopTreEm
{
	public partial class frmShopTreEm : Form
	{
		private int ID_BH;
		...
		public frmShopTreEm(QuanTriVien_DTO loginAccount)
		{
			InitializeComponent();
	    ...
	    void frmShopTreEm_Load(object sender, EventArgs e)
		{
			this.Text = "Quản lý cửa hàng trẻ em - Xin chào " + loginAccount.TenDangNhap + "!";
