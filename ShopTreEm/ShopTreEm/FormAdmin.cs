...
namespace ShopTreEm
{
    public partial class frmAdmin : Form
    {
        ...
        private void txtIDQA_TextChanged(object sender, EventArgs e)
        {
        ...
        private void btnBrowseHinhQA_Click(object sender, EventArgs e)
        {
        ...
        private void btnTK_Sua_Click(object sender, EventArgs e)
        {
            ...
            if (kieuTaiKhoan.Ten_KTK == "Quản trị viên")
            {
                DialogResult dialogResult = MessageBox.Show("Bạn có chắc muốn sửa không, đây là một tài khoản quản trị viên?", "Cảnh báo", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (dialogResult == DialogResult.No)
                {
                    return;
                }
            }
            if (QuanTriVien_DAO.Instance.SuaTaiKhoan(kieuTaiKhoan.ID_KTK, tenDN, matKhau))
            {
            ...
            {
                MessageBox.Show("Sửa tài khoản không thành công", "Thông báo lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
